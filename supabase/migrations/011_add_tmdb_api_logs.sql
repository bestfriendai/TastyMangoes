--  011_add_tmdb_api_logs.sql
--  Created automatically by Cursor Assistant
--  Created on: 2025-12-22 at 12:58 (America/Los_Angeles - Pacific Time)
--  Notes: Track all TMDB API calls for analytics and monitoring
...
-- Remove default from endpoint after ensuring it exists (if needed)
DO $$
BEGIN
